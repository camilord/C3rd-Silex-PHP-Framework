...
class Sanitizer {
    ...
    public static function numeric_cleaner($text = '') {
        return preg_replace( '/[^0-9.]/', '', $text);
    }

    public static function alpha_cleaner($text = '', $withSpace = false) {
        return ($withSpace) ? preg_replace('/[^a-zA-Z ]/', '', $text) : preg_replace('/[^a-zA-Z]/', '', $text);
    }

    public static function text_cleaner($text = '', $withSpace = true) {
        return ($withSpace) ? preg_replace( '/[^a-zA-Z0-9._\-: ]/', '', $text) : preg_replace( '/[^a-zA-Z0-9]/', '', $text);
    }
